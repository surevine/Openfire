...
public class MixChannelJidMapNode extends LeafNode {

	public static final String NODE_ID = "urn:xmpp:mix:nodes:jidmap";
	
	private MixChannel mixChannel;
	
	public MixChannelJidMapNode(final MixChannel channel) {
	...
	private Element mapItem(MixChannelParticipant participant) {
		...
		payload.element("participant").addAttribute("jid", participant.getRealJid().toBareJID());
